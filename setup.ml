...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1c49a5f17cb6a3e147a3682de4f6c54d) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_pcap_writes.ml"
                   });
               Test
                 ({
                     cs_name = "pcap_writes";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\179II\021\024\1297\238\r\168%\002\144\003\245\214";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
