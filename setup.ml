...
(* OASIS_START *)
(* DO NOT EDIT (digest: 823744ec5044be1ef745234cde057dd4) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_pcap_writes", []))];
          ...
          ("netif",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_netif", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "PCAP reader (via fs) represented as a netif for use in mirage";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Netif"; "Pcap_write"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-net-pcap";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "test_pcap_writes";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "mirage-net-pcap";
                   ...
                   {exec_custom = true; exec_main_is = "test_pcap_writes.ml"});
               Executable
                 ({
                     cs_name = "test_netif";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_netif.ml"});
               Test
                 ({
                     cs_name = "pcap_writes";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "L+\158\245\134t\239f\205-\135\158\017\171\176\166";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
